        ...
        implements AutoCloseable, Iterable<ArrowRecordBatch>
{
     ...
     */
    public void verify(QueryTicket ticket)
    {
    ...
    public static class StreamCreator
    {
        ...
        {
            io.prestosql.server.arrow.Stream stream = new io.prestosql.server.arrow.Stream(schema, dictionaryProvider, batches, recordCount);
